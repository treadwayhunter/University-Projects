...
public class GameOverScreen implements Screen {
    ...
    public void show() {
        ...
        TextButton startButton = new TextButton("Play Again?", skin, "default");
        ...
        quitButton.setPosition((float) Gdx.graphics.getWidth()/2, (float)Gdx.graphics.getHeight() / 2 - 200);
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, "Game Over", (float) Gdx.graphics.getWidth() / 2, ((float) Gdx.graphics.getHeight() / 2) + 100);
        batch.end();
